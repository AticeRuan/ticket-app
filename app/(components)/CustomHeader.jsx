    ...
    <section className="flex items-center w-full  px-[40px] py-[25px] justify-between bg-chill-black/80 sm:bg-transparent fixed top-0 z-20 sm:static backdrop-blur-lg">
      ...
      <div className="flex items-center gap-1 sm:gap-[10px] justify-between bottom-5 right-5 z-10">
        <div className="relative group">
          ...
          {user && (
            <span className="absolute px-2 py-1 rounded-lg border bg-chill-white/60 text-xs border-chill-white/80 backdrop-blur-md shadow-xl text-chill-black/80 top-[50px] -left-[30px] hidden  group-hover:block z-30">
              {email}
            </span>
          )}
        </div>
        ...
        >
          <span className="absolute p-1 rounded-lg border  bg-chill-white/60 text-xs border-chill-white/80  backdrop-blur-md shadow-xl text-chill-black/80 top-[50px] left-[3px] hidden  group-hover:block">
            Logout
          </span>
